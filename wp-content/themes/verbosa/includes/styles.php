...
function verbosa_enqueue_styles() {
	...
	/* Arabi */
	wp_enqueue_style( 'verbosa-projectweek-animate', get_template_directory_uri() . '/projectweek/animate.css', null, _CRYOUT_THEME_VERSION  );
...
function verbosa_add_editor_styles() {
	...
	/* Arabi */
	wp_enqueue_script( 'verbosa-frontend', get_template_directory_uri() . '/projectweek/wow.min.js', array('jquery'), _CRYOUT_THEME_VERSION);
